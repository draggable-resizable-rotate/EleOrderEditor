...
export interface ModuleClass<PropsType, ViewComponentProps, ConfigFormComponentProps = Record<string, unknown>, StyleFormComponentProps = Record<string, unknown>> {
